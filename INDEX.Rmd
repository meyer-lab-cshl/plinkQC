...
[![Downloads](http://cranlogs.r-pkg.org/badges/grand-total/plinkQC?color=red)](http://cran.rstudio.com/web/packages/plinkQC/index.html)
...
The current github version of **plinkQC**  is: 0.1.1 and can be
installed via
...
The current CRAN version of **plinkQC**  is: 0.1.0 and can be
installed via
