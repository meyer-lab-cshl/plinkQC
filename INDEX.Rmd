...
A step-by-step guide on how to run these analyses can be found [here](plinkQC.html). Individuals and markers that fail the quality control can subsequently be removed with **plinkQC** to generate a new, clean dataset.
