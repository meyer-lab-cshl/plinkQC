...
[![CRAN_Status_Badge](https://www.r-pkg.org/badges/version/plinkQC)](https://cran.r-project.org/package=plinkQC)
[![Build Status](https://travis-ci.org/HannahVMeyer/plinkQC.svg?branch=master)](https://travis-ci.org/HannahVMeyer/plinkQC)
...
Full documentation is available at https://HannahVMeyer.github.io/plinkQC/.
...
The current github version of **plinkQC**  is: 0.2.3 and can be
installed via
```{r github install, eval=FALSE}
library(devtools)
install_github("HannahVMeyer/plinkQC")
```
The current CRAN version of **plinkQC**  is: 0.2.3 and can be
installed via
