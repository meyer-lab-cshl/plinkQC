...
```{r individual QC,  fig.height=12, fig.width=9}
...
```{r marker QC, fig.height=9, fig.width=6, fig.align='center'}
...
```{r check snp missing, fig.height=3, fig.width=5, fig.align='center'}
...
```{r check hwe, fig.height=3, fig.width=5, fig.align='center'}
...
```{r check maf, fig.height=3, fig.width=5, fig.align='center'}
