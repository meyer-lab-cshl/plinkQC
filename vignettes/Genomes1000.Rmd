...
is available and should be downloaded as in input for `plinkQC::check_ancestry()`.
...
have been updated in the past, which means the links below where outdated.
...
sample=https://www.dropbox.com/s/3j9zg103fi8cjfs/all_hg38.psam?dl=1
...
plink2 --pfile $refdir/all_hg38 vzs\
      ...
      --allow-extra-chr 0 \
      --out $refdir/all_hg38
mv $refdir/all_hg38.log $refdir/log
```
