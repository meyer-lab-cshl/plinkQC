...
['Processing 1000Genomes  reference data for ancestry estimation'](), show the
download and processing of the HapMap phase III and 1000Genomes phase III
dataset, respectively. In this example, we will use the HammapIII data as the
reference dataset.
...
```{r check ancestry, eval=TRUE, fig.height=3, fig.width=5, fig.align='center'}
library(plinkQC)
package.dir <- find.package('plinkQC')
qcdir <- file.path(package.dir,'extdata')
alg <- 'data'
refname <- 'HapMapIII'
prefixMergedDataset <- paste(alg, ".", refname, sep="")

exclude_ancestry <-
    check_ancestry(qcdir=qcdir, alg=alg,
                   ...
                   run.check_ancestry=FALSE, interactive=TRUE)
```
