...
into PLINK format. Vignettes xx and xx, show the download and processing of the
HapMapIII and 1000Genomes phase 3 dataset, respectively. In this example, we
will use HammapIII data as the reference dataset.
...
```{r, engine='bash', prune, eval=FALSE, background='#F7F7F7'}
...
exclude_ancestry <- check_ancestry(qcdir=qcdir, alg=alg,
                            ...
                            refColorsFile=paste(qcdir, "/HapMap_PopColors.txt",
                                                 sep=""),
                            prefixMergedDataset=paste(alg, ".", refname,
                                                      sep=""),
                            interactive=TRUE)
```
