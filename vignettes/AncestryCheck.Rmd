...
`git lfs fetch` to make sure the correct file gets downloaded. Then, unzip the folder
for future. 
...
To ensure a balanced model, we will sample the data to ensure an even representation of each ancestral superpopulation group in the testing portion of the data.
For a roughly 70% split of the data, this is 448 samples in each of the five ancestral groups.
