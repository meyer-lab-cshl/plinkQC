...
plinkQC contains a pre-trained random forest classifier to predict genomic ancestry for 
human data. It was trained on the principal components of the [harmonized 1000 Genomes and Human Genome Diversity Project datasets](https://genome.cshlp.org/content/34/5/796).
This method is based off the ancestry identification scheme used in the [Pan-UK 
BioBank analysis](https://pan.ukbb.broadinstitute.org/). More details of the 
training of the classifier is included in the manuscript.
